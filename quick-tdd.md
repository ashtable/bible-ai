...
1. Spawn a new general purpose agent to review the code in the current repo as well as the most recent commits
2. Spawn a new general purpose agent to review the context from Step 1, and then reframe and reword the user's request to clearly communicate the user's request from the context of Step 1 
